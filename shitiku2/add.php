...
<p><label>选项A:</label> 
<textarea id="intro" name="chooseA" rows="2" cols="60" style="resize:none;"></textarea></p>
<p><label>选项B:</label> 
<textarea id="intro" name="chooseB" rows="2" cols="60" style="resize:none;"></textarea></p>
<p><label>选项C:</label> 
<textarea id="intro" name="chooseC" rows="2" cols="60" style="resize:none;"></textarea></p>
<p><label>选项D:</label> 
<textarea id="intro" name="chooseD" rows="2" cols="60" style="resize:none;"></textarea></p>
