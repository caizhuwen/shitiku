...
<table width="80%"  border="1" align="center" cellpadding="0" cellspacing="1" background="images/top1.jpg" >
      ...
      <tr>
        <td height="35"  colspan="2" align="center" >试题类别统计</td>
      </tr>
    
      <tr>
        <td align="center" bgcolor="#FFFFFF" height="27">试题类别</td>
        <td align="center" bgcolor="#FFFFFF">数据库内试题</td>
      </tr>
      
      <?php 
	  $sql="select subject, count(*) from question where deletes='0' group by subject";
	  $res=mysql_query($sql);
	  while($arr=mysql_fetch_row($res)){
	  echo "<tr height='30'>";
	  echo "<td align='center' bgcolor='#FFFFFF'>".$arr[0]."</td>";
	  echo "<td align='center' bgcolor='#FFFFFF'>该类别试题共有：".$arr[1]."道</td>";
	  echo "</tr>";
	  }
	  ?>
